...
| image.digest | string | `"sha256:85c3b1e543cb817727dbf2480927d437d69aced547f4fd0bf8be2c2c24481967"` |  |
| image.pullPolicy | string | `"Always"` |  |
| image.pullSecrets | list | `[]` |  |
| image.registry | string | `"ghcr.io"` |  |
| image.repository | string | `"kubelauncher/mariadb"` |  |
| image.tag | string | `"12.3.2"` |  |
| metrics.containerPorts.metrics | int | `9104` |  |
| metrics.enabled | bool | `false` |  |
| metrics.image.pullPolicy | string | `"Always"` |  |
| metrics.image.registry | string | `"ghcr.io"` |  |
| metrics.image.repository | string | `"kubelauncher/mysqld-exporter"` |  |
| metrics.image.tag | string | `"0.18.0"` |  |
...
| secondary.containerPorts.mariadb | int | `3306` |  |
...
| secondary.persistence.mountPath | string | `"/data/mariadb"` |  |
...
| secondary.service.nodePorts.mariadb | string | `""` |  |
| secondary.service.ports.mariadb | int | `3306` |  |
